...
class GLSTM(nn.Module):
    ...
    def forward(self, x, hn1_1, cn1_1, hn1_2, cn1_2, hn2_1, cn2_1, hn2_2, cn2_2 ):
        out = x
        ...
        lstm1_front, (hn1_1, cn1_1)  = self.lstm_list1[0](param1[0], (hn1_1, cn1_1))
        lstm1_back,  (hn1_2, cn1_2)  = self.lstm_list1[1](param1[1], (hn1_2, cn1_2))
        ...
        lstm2_front, (hn2_1, cn2_1)  = self.lstm_list2[0](param2[0], (hn2_1, cn2_1))
        lstm2_back,  (hn2_2, cn2_2)  = self.lstm_list2[1](param2[1], (hn2_2, cn2_2))
        out = torch.cat([lstm2_front, lstm2_back], dim=-1)
        out = self.ln2(out)
        out = out.view(out.size(0), out.size(1), x.size(1), -1).contiguous()
        out = out.transpose(1, 2).contiguous()
        
        return out, hn1_1, cn1_1, hn1_2, cn1_2, hn2_1, cn2_1, hn2_2, cn2_2 
...
class CRNN(nn.Module):
    ...
    def forward(self, x, md_hn1_1, md_cn1_1, md_hn1_2, md_cn1_2, md_hn2_1, md_cn2_1, md_hn2_2, md_cn2_2):
        out = x
        ...
        out, md_hn1_1, md_cn1_1, md_hn1_2, md_cn1_2, md_hn2_1, md_cn2_1, md_hn2_2, md_cn2_2 = self.glstm(out, md_hn1_1, md_cn1_1, md_hn1_2, md_cn1_2, md_hn2_1, md_cn2_1, md_hn2_2, md_cn2_2)       #[3,256,1,15]
        ...
        return out, md_hn1_1, md_cn1_1, md_hn1_2, md_cn1_2, md_hn2_1, md_cn2_1, md_hn2_2, md_cn2_2
